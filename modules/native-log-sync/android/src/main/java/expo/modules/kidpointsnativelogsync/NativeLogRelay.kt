...
class NativeLogRelay(
  ...
  fun debug(tag: String, message: String, contextJson: String? = null) {
    log("debug", tag, message, contextJson)
  }

  fun info(tag: String, message: String, contextJson: String? = null) {
    log("info", tag, message, contextJson)
  }

  fun temp(tag: String, message: String, contextJson: String? = null) {
    log("temp", tag, message, contextJson)
  }

  fun warn(tag: String, message: String, contextJson: String? = null) {
    log("warn", tag, message, contextJson)
  }

  fun error(tag: String, message: String, contextJson: String? = null) {
    log("error", tag, message, contextJson)
  }

  fun log(level: String, tag: String, message: String, contextJson: String? = null) {
